...
public class Main extends JFrame implements KeyListener {
    ...
    private int score; //Текущий счет игры
    private JLabel label; //Отобразить метку оценки
    private JLabel label1; //Показываем окончина ли игра
    private boolean running; //Что бы определить состояние игры окончена/нет
    ...
    public Main() {
        ...
        label1 = new JLabel("Start Game");//// Этот ярлык напоминает о состоянии игры: начало или конец
    ...
    public void init() {
        ...
        JPanel right = new JPanel(); //панель информации сотояния игры (боковая панель)
   ...
   // Рисуем падающую сетку
    ...
    public void start (){
        x = 0; //инициализируем начальное положение падающего квадрата
        y = 5;
    ...
    public void removeRow(int row) {
        ...
        reflesh (); // вызываем метод обновления области главной панели игры после удаления блока строки
